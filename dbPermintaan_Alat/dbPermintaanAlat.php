...
<body>
  ...
  <div class="container mt-1">
    <h4 class="text-center">Form Permintaan Alat</h4>
      ...
      <div class="container-fluid">
        <form action="" method="post" class="row g-3 mt-2">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="jumlahdiberi" name="jumlahdiberi" />
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <label for="ygmenyetujui" class="form-label">Yang Menyetujui</label>
            <input type="text" class="form-control" id="ygmenyetujui" name="ygmenyetujui" />
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <label for="alat" class="form-label">Kondisi Alat</label>
            <select id="alat" name="alat" class="form-select form-select-sm" aria-label="Default select example ">
              <div>
          ...
          <div class="d-flex gap-2 d-md-relative justify-content-md-end">
            ...
            <a href="../Form_Rekap_Data/permintaanalat.php" class="btn btn-secondary btn-mb active" role="button" aria-pressed="true">Menu_Rekap</a>
          </div>
        </form>
      </div>
    </div>
