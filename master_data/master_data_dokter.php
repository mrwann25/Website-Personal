...
<body>
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
         ...
         <li>
          ...
          <?php if ($Level == 2 or $Level == 3) { ?>
            ...
            <li><a class="dropdown-item" href="../dashboard_pemesanan/dashboardpemasanan.php">
                Permintaan Stok Bahan</a></li>
            <li>
              <a class="dropdown-item" href="../dbPermintaan_Alat/dbPermintaanAlat.php">Permintaan Alat Masak/Makan Pasien</a>
            </li>
            <li>
  ...
  <div class="container mt-2">
    <h4 class="text-center">Master Data Dokter</h4>
    <div class="col-lg-6 col-lg-offset-3">
      <form action="" method="post" enctype="multipart/form-data">
        <div>
          <button type="button" class="btn btn-warning">
            <a href="../master_data/input_data_dokter.php" onclick="return confirm('yakin?')" style="text-decoration: none; color:black">Masukkan Data</a>
          </button>
    ...
    <thead>
      ...
      <table class="table table-sm table-bordered border border-dark mt-2">
        ...
        <thead>
          ...
          $i = 1;
          $sqlgetdata = mysqli_query($conn, "SELECT * FROM database_dokter ORDER BY id_dokter DESC")
          ?>
          ...
          foreach ($sqlgetdata as $row) : ?>
            ...
            <td> <?= $row["jabatan_dokter"]; ?> </td>
            <td> <?= $row["status_dokter"]; ?> </td>
            <td>
              <button type="button" class="btn btn-info"> 
                  <a href="../editdata/editdatadokter.php?id_dokter=<?= $row["id_dokter"]; ?>" onclick="return confirm('yakin?')" style="text-decoration: none; color:black"><span class="bi bi-pencil-square">Edit</span></a>
               </button>
            </td>
            </tr>
          <?php endforeach; ?>
