...
$q = mysqli_query($conn, "SELECT * FROM db_pemesananbahanmakan");

// tampilkan seluruh data sesuai dengan halaman
$pemesanan = query("SELECT * FROM db_pemesananbahanmakan ORDER BY id DESC LIMIT $DataAwal, $jumlahdataperhalaman");

// tombol cari ditekan
if (isset($_POST["caripemesanan"])) {
  $q = caripemesanan($_POST["keyword"]);
}
...
if (isset($_POST['submit1'])) {
  ...
  if (!empty($date1) && !empty($date2)) {
    ...
    $q = mysqli_query($conn, "SELECT * FROM db_pemesananbahanmakan WHERE tanggal BETWEEN '$date1' and '$date2'");
  } else {
...
<head>
  ...
  <a href="../Function_Ubah_Pemesanan/Function_Ubahpemesanan.php"></a>
</head>
<body>
  <!-- css footer -->
  <style>
...
<body>
  ...
  <div class="container mt-2">
    ...
    <!-- Tittle -->
    <h1 style="text-align: center;">Rekap Permintaan Bahan Makan Kering</h1>
    <form action="" method="post" class="mb-2">
      <input type="text" name="keyword" size="40" autofocus placeholder="masukkan keyword pencarian!!" autocomplete="off">
      <button type="submit" name="caripemesanan">Cari Data</button>
    </form>
    ...
    <form action="" method="post" class="mb-2">
      ...
      <div class="row g-2 align-items-center mb-0">
        ...
        <div class="col-auto ">
          <a href="../dashboard_pemesanan/dashboardpemasanan.php" class="btn btn-dark">Form Input</a>
        </div>

      </div>
    </form>

    <!-- Table Data Pemesanan Bahan Makan -->
          ...
          <tr class="text-center">
            ...
            <td>
              <button type="button" class="btn btn-info"> 
                  <a href="../editdata/editpemesanan.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin?')" style="text-decoration: none; color:black"> <span class="bi bi-pencil-square">Edit </span></a>
              </button>
              <button type="button" class="btn btn-warning"> 
                  <a href="../Function_Hapus/hapuspemesanan.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin?')" style="text-decoration: none; color:black"> <span class="bi bi-trash">Hapus </Span></a>
              </button>
            </td>
          </tr>
        <?php $i++;
    ...
    <nav>
      ...
      <div class="d-flex justify-content-end">
        ...
        <a target="_blank" href="../cetak_makanan.php?TglAwal=<?= $date1 ?>&TglAkhir=<?= $date2 ?>"><button style="background-color: smoke;">Download</button></a>
      </div>
    </nav>
  </div>
  <div class="footer">
