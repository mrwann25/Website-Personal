...
<body>
  ...
  <div class="container mt-1">
    <h4 class="text-center">Form Diet Pasien</h4>
      ...
      <div class="container-fluid">
        <form action="" method="post" class="row g-3 mt-2">
          ...
          <div class="col-md-3">
            ...
            <input type="date" name="Tanggal" class="form-control form-control-sm" id="Tanggal" required />
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            ...
            <input type="date" name="Tanggal1" class="form-control form-control-sm" id="Tanggal1" required value="" />
          </div>

          <div class="col-md-3">
            <label for="Tanggal2" class="form-label">Tanggal/Jam_Mrs</label>
            <input type="datetime-local" name="Tanggal2" class="form-control form-control-sm" id="Tanggal2" required />
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            ...
            <input type="text" name="DietSiang" class="form-control form-control-sm" id="DietSiang" />
          </div>
          <div class="col-md-3">
            <label for="DietSore" class="form-label">Diet_Sore</label>
            <input type="text" name="DietSore" class="form-control form-control-sm" id="DietSore" />
          </div>
          <div class="col-md-3">
            <label for="DietPagi" class="form-label">Diet_Pagi</label>
            <input type="text" name="DietPagi" class="form-control form-control-sm" id="DietPagi" />
          </div>
          ...
          <div class="d-flex gap-2 d-md-relative justify-content-md-end mb-1">
            ...
            <a href="../Form_Rekap_Data/rekapdatadiet.php" class="btn btn-secondary btn-mb active" role="button" aria-pressed="true">Menu_Rekap</a>
